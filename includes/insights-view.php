...
<header class="site-header"><a class="brand" href="/" aria-label="CloudSys home"><img src="/assets/cloudsys-logo.png" width="794" height="243" alt="CloudSys"></a><button class="menu-toggle" type="button" aria-expanded="false" aria-controls="primary-nav" aria-label="Open navigation"><span></span><span></span><span></span></button><nav id="primary-nav" aria-label="Primary navigation"><a href="/netsuite-optimization.html">NetSuite Optimization</a><a href="/ai-agents.html">AI &amp; Automation</a><a href="/case-studies.html">Client Results</a><a href="/managed-support.html">Managed Support</a><a href="/insights" aria-current="<?= $article ? 'location' : 'page' ?>">Insights</a><a href="/about.html">About</a></nav><a class="header-contact" href="/#contact">Talk to an expert <span aria-hidden="true">↗</span></a></header>
<?php
}
...
{
    ?>
<footer><a href="/">CloudSys home</a><nav class="footer-links" aria-label="Explore and legal"><a href="/insights">Insights</a><a href="/integrations-development.html">Development</a><a href="/privacy.html">Privacy Policy</a><a href="/cookies.html">Cookie Policy</a><button type="button" data-manage-cookies>Cookie Preferences</button></nav></footer>
</body></html>
<?php
}
